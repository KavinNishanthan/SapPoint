    ...
    <main>
        <div class="addStudent-container">
		    ...
		    if($_SESSION['designation'] == '4') {
                    ...
                    $json_data = file_get_contents('https://script.google.com/macros/s/AKfycbwUUWGbIElhOhOSEwkHgJQQWLlzBo7-AQ_84OcqjQaVcyrRxvr1GQvwmaNXptCIHx-_/exec');
                            ...
                            if($_SESSION['designation'] == '4') {
                                if($staffDepartment[0] == $department) {
                                    ...
                                    if(mysqli_num_rows($result) > 0) {
                                        ...
                                        $sql = "INSERT INTO Student (rollNumber,studentName,studentEmail,mentor,studentBatch,department,section,currentSemester,passcode,verifyToken) VALUES ('$rollNumber','$studentName','$studentEmail','$mentor','$studentBatch','$department','$section','$semester','$passcode','$verifyToken');";
